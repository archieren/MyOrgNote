...
Medium上有片博客! [[https://medium.com/intuitionmachine/the-hierarchical-reasoning-model-through-the-lens-of-quaternion-process-theory-thinking-fast-and-1fc948dad97f][The Hierarchical Reasoning Model Through the Lens of Quaternion Process Theory:Thinking Fast and Slow, Empathetically and Fluently]]
...
**** 在本身并不是一维的数据领域,运用Mamba之类的技术,需要将数据序列化!这背后隐藏着什么?
