...
* Capsulenet
对这个网络,不能用纯粹的数学或技术眼光看.要看他们二十年来在坚持什么！它那背后简单而又完美的理念！
...
CNN丢失了feature的状态信息."胶囊"不仅要提供feature出现的概率,还要提供feature的状态信息！

** "Dynamic Routing Between Capsules"
*** "Routing by agreement"
From bottom to up, to construct Parse Tree or Hierarchical Representation!
