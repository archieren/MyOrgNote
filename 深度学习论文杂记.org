...
*** Sparse Object Detection Methods.
*** New label-assignment methods.
**** Considering label assignment from a global view.(?What's the meaning)
*** What makes for a end-to-end object detection?
*** How to segment objects by learning queries?
*** Viewing object detection as set-prediction task.
*** Replacing Anchors with learned object query.
这是值得仔细思考的内容!
