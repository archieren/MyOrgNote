...
还有老的,[TokenPose],[VitPose]等等,还是很多的！
...
有关descriptor的文章多,而detector的内容少![2019 - USIP: Unsupervised Stable Interest Point Detection from 3D Point Clouds]
由于容易获得GroundTruth,基于深度学习的descriptor,有比较好的发展!
而detector就没有这样的便利处！
